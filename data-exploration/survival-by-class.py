...
survived = survived_subset['Pclass'].value_counts()
dead = dead_subset['Pclass'].value_counts()
...
print("\nPercentage of Class 2 that survived: {}%".format(round(Class2_survived)))
print("\nPercentage of Class 3 that survived: {}%".format(round(Class3_survived)))
